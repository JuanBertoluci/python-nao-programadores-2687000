...
total_dias = input('Quantos dias por semana você quer estudar?')
# 3. Crie uma variável chamada "total_horas" e, usanod o método input(), solicite a média de horas estudada por dia;
total_horas = input('Quantas horas por dia você quer estudar?')
...
print(f'Olá {nome}, você costuma estudar {total_dias} dias por semana, tendo uma média de {total_horas} horas de estudo por dia. Isso significa que você estuda em média {total_horas*total_dias} por semana no curso de {curso}!')
